                      ...
                      >
                        ...
                        >
                          <div className="flex justify-between items-center">
                            ...
                            <div className="flex items-center gap-2">
                              <div className="w-4 h-4 bg-gradient-to-r from-indigo-400 to-pink-400 rounded-full flex items-center justify-center text-xs text-white">
                      ...
                      >
                        ...
                        >
                          <div className="flex justify-between items-center">
                            ...
                            <div className="flex items-center gap-2">
                              <div className="w-6 h-6 bg-gradient-to-r from-indigo-400 to-pink-400 rounded-full flex items-center justify-center text-sm text-white">
                                {request.client?.username?.charAt(0)?.toUpperCase() || "?"}
                              </div>
