                  ...
                  <div className="flex justify-between items-start overflow-hidden">
                    <div className="flex-1 overflow-hidden">
                      <div className="flex items-center gap-2 mb-2">
                        ...
                        <h4 className="font-semibold text-gray-800 text-sm break-words flex-1">{event.title}</h4>
                        <span className={`px-2 py-1 rounded-full text-xs font-medium flex-shrink-0 ${getEventTypeColor(event.event_type)}`}>
                          {event.event_type}
                        </span>
                        {event.isAutoGenerated && (
                      ...
                      {event.description && (
                        <p className="text-gray-600 text-xs mb-2 break-words line-clamp-2">{event.description}</p>
                      )}
                      
                      <div className="flex flex-col gap-1 text-xs text-gray-500 overflow-hidden">
