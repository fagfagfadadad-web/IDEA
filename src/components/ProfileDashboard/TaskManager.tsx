      ...
      <div className="space-y-6">
        ...
        <div className="flex justify-between items-center">
          ...
          <Button
            ...
            className="bg-indigo-600 hover:bg-indigo-700 text-white px-3 py-2 rounded-lg flex items-center gap-1 text-sm"
          >
            <Plus size={14} />
            Add Task
          </Button>
                ...
                <div>
                  ...
                  <div className="space-y-2 overflow-hidden">
                    {pendingTasks.map((task) => (
                      <div
                        key={task.id}
                        className="flex items-center justify-between p-2 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors overflow-hidden"
                      >
                        <div className="flex items-center gap-3 flex-1">
                          ...
                          <div className="flex-1 overflow-hidden">
                            <p className="text-gray-800 font-medium text-sm break-words">{task.title}</p>
                            {task.description && (
                              <p className="text-gray-600 text-xs break-words line-clamp-1">{task.description}</p>
                            )}
                            {task.due_date && (
                ...
                <div>
                  ...
                  <div className="space-y-2 overflow-hidden">
                    {completedTasks.slice(0, 3).map((task) => (
                      <div
                        key={task.id}
                        className="flex items-center justify-between p-2 bg-green-50 rounded-lg opacity-75 overflow-hidden"
                      >
                        <div className="flex items-center gap-3 flex-1">
                          <button
                            onClick={() => handleToggleStatus(task.id, task.status)}
                          ...
                          <div className="flex-1 overflow-hidden">
                            <p className="text-gray-700 font-medium line-through text-sm break-words">{task.title}</p>
                            <p className="text-gray-500 text-xs break-words">
