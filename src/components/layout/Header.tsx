          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="hidden lg:block relative">
              <button
                ...
                className="inline-block rounded-lg px-3 py-2 text-center hover:no-underline my-0 text-gray-600 hover:bg-slate-100 mx-0 transition-colors flex items-center gap-2"
              >
                <MenuIcon size={16} />
                Menu
              </button>
              ...
              {isProfileMenuOpen && (
                <>
                  ...
                  <div className="absolute left-0 top-full mt-2 w-48 bg-white border border-gray-200 rounded-lg shadow-lg z-20">
                    <Link
                      to="/profile"
                      className="flex items-center gap-2 px-4 py-3 text-gray-800 hover:bg-gray-50 rounded-t-lg transition-all duration-200"
                      onClick={() => setIsProfileMenuOpen(false)}
                    >
                      <User size={16} />
                      Profile
                    ...
                    <Link
                      to="/my-requests"
                      className="flex items-center gap-2 px-4 py-3 text-gray-800 hover:bg-gray-50 transition-all duration-200"
                      onClick={() => setIsProfileMenuOpen(false)}
                    >
                      <Briefcase size={16} />
                      My Requests
                    ...
                    <button
                      ...
                      className="flex items-center gap-2 px-4 py-3 text-orange-600 hover:bg-orange-50 transition-all duration-200 w-full text-left"
                    >
                      <Wallet size={16} />
                      Reconnect Wallet
                    </button>
