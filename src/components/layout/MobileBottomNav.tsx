            ...
            <div className="w-8 h-8 rounded-full overflow-hidden relative">
              {profile?.avatar_url ? (
                <>
                  ...
                  />
                  <div 
                    className="fallback-avatar w-full h-full bg-gray-800 rounded-full flex items-center justify-center text-xs text-white absolute inset-0"
                    style={{ display: 'none' }}
                  >
                ...
                <div className="w-full h-full bg-gray-800 rounded-full flex items-center justify-center text-xs text-white">
                  {profile?.username?.charAt(0)?.toUpperCase() || "U"}
                </div>
              )}
            </div>
