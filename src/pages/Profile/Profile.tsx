                            ...
                            {isOwnProfile && (
                              <div className="flex gap-2 pt-2">
                                <Button
                                  ...
                                  className="flex-1 bg-blue-600 hover:bg-blue-700 text-white py-2 px-3 rounded flex items-center justify-center gap-2"
                                >
                                  <Eye size={14} />
                                  View
                                </Button>
                                <Button
                                  ...
                                  className="flex-1 bg-gray-600 hover:bg-gray-700 text-white py-2 px-3 rounded flex items-center justify-center gap-2"
                                >
                                  <Edit size={14} />
                                  Edit
                                </Button>
