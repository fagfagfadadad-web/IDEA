            ...
            <div className="bg-gradient-to-br from-purple-600 to-purple-700 rounded-2xl p-3 sm:p-4 border-2 border-purple-500 space-y-2">
              ...
              <div className="flex items-center gap-2 w-full">
                <input
                  ...
                  placeholder="0.0"
                  className="flex-1 bg-transparent text-xl sm:text-2xl font-inter font-bold outline-none text-white placeholder-purple-300 min-w-0"
                />
              ...
              <div className="flex items-center gap-2 w-full">
                <div className="flex-1 min-w-0">
                  {isLoadingQuote ? (
                    ...
                    <div className="text-xl sm:text-2xl font-inter font-bold text-white break-all">
