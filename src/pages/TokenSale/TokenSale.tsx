  ...
  if (isExpired) {
    return (
      <div className="text-center">
        <p className={`text-gray-100 ${isMobile ? 'text-lg' : 'text-xl'} font-bold text-shadow-sm`}>
          Phase Ended
        </p>
      </div>
    );
  ...
  return (
    <div className={`flex ${isMobile ? 'gap-2' : 'gap-4'} justify-center`}>
      {[
        ...
        <div key={label} className="text-center" style={{ width: isMobile ? '60px' : '88px' }}>
          <div
            className={`bg-gray-900 rounded-xl shadow-lg border border-purple-500/50 ${
              isMobile ? 'h-12 leading-12 text-2xl' : 'h-16 leading-16 text-4xl'
            } font-bold text-white mb-1 flex items-center justify-center animate-[flip_0.3s_ease-in-out]`}
            style={{ textShadow: '0 1px 1px rgba(0, 0, 0, 0.3)' }}
          >
            {value}
          </div>
          <p className={`${isMobile ? 'text-sm' : 'text-base'} text-gray-100 uppercase font-bold tracking-wide`}>
            {label}
          </p>
        </div>
      ))}
...
const PhaseCard: React.FC<{
  ...
  return (
    <div className={`relative overflow-hidden rounded-3xl border-2 transition-all duration-500 transform hover:scale-105 ${
      isActive 
        ? 'border-purple-500 bg-gradient-to-br from-purple-900/90 to-indigo-900/90 shadow-2xl shadow-purple-500/30'
        : isCompleted
        ? 'border-green-500 bg-gradient-to-br from-green-900/90 to-emerald-900/90'
        : 'border-gray-700/50 bg-gradient-to-br from-gray-900/90 to-slate-900/90'
    }`}>
      ...
      <div className={`p-${isMobile ? '10' : '12'} space-y-8`}>
        <div className="space-y-2">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className={`${isMobile ? 'text-2xl' : 'text-3xl'} font-bold text-white text-shadow-sm`}>
                {title}
              </h3>
        ...
        <div className="grid grid-cols-2 gap-6">
          <div className="bg-gray-900/90 rounded-xl p-6 border border-gray-700/50 hover:bg-gray-800/90 transition-all duration-300">
            <div className="flex items-center gap-2 mb-2">
              <Target size={18} className="text-purple-100" aria-hidden="true" />
              <span className="text-gray-100 text-sm font-medium uppercase tracking-wide">Total Supply</span>
            </div>
            <p className="text-white text-xl font-bold text-shadow-sm">
          ...
          <div className="bg-gray-900/90 rounded-xl p-6 border border-gray-700/50 hover:bg-gray-800/90 transition-all duration-300">
            <div className="flex items-center gap-2 mb-2">
              <DollarSign size={18} className="text-green-100" aria-hidden="true" />
              <span className="text-gray-100 text-sm font-medium uppercase tracking-wide">Price</span>
            </div>
            <p className="text-white text-xl font-bold text-shadow-sm">
        ...
        <div className="space-y-6">
          <div className="flex justify-between items-center">
            <span className="text-white font-semibold text-lg text-shadow-sm">Sale Progress</span>
            <span className="text-white font-bold text-xl text-shadow-sm">{progress.toFixed(1)}%</span>
          </div>
        ...
        {isActive && (
          <div className="bg-gray-900/90 rounded-xl p-6 border border-gray-700/50">
            <div className="text-center space-y-4">
              <div className="flex items-center justify-center gap-2">
                <Clock size={20} className="text-purple-100" aria-hidden="true" />
                <span className="text-white font-semibold text-lg text-shadow-sm">Time Remaining</span>
              </div>
...
const BuyForm: React.FC<{
  ...
  return (
    <div className="bg-gray-900/90 rounded-3xl shadow-2xl border border-gray-700/50 overflow-hidden">
      <div className="bg-gradient-to-r from-purple-600 to-indigo-600 p-8 text-white">
        <div className="flex items-center gap-3 mb-2">
          <div className="w-12 h-12 bg-gray-900/90 rounded-full flex items-center justify-center shadow-lg">
            <Coins size={24} aria-hidden="true" />
          </div>
          <div>
            <h3 className={`${isMobile ? 'text-2xl' : 'text-3xl'} font-bold text-shadow-sm`}>
              Buy IDA Tokens
            </h3>
            <p className="text-gray-100 text-base">
        ...
        {!isPhaseActive && (
          <div className="bg-red-600/30 border border-red-400/50 rounded-xl p-4 mt-4">
            <p className="text-white text-base font-medium text-shadow-sm">
      ...
      <div className="p-8 space-y-8">
        <div className="space-y-3">
          <label className="block text-white font-semibold text-lg text-shadow-sm">
          ...
          <input
            ...
            className="w-full p-4 bg-gray-900 border border-purple-500 rounded-xl text-white placeholder-gray-400 focus:ring-2 focus:ring-purple-500 focus:bg-gray-800 transition-all duration-300 text-lg font-medium"
        ...
        <div className="bg-gray-900/90 rounded-xl p-6 space-y-4 border border-gray-700/50">
          <h4 className="text-white font-bold text-lg text-shadow-sm">Purchase Summary</h4>
          <div className="space-y-3">
            <div className="flex justify-between">
              <span className="text-gray-100 font-medium">You Pay:</span>
              <span className="text-white font-bold text-lg text-shadow-sm">
                {egldCost.toFixed(8)} EGLD
              </span>
            </div>
            <div className="flex justify-between">
              <span className="text-gray-100 font-medium">You Receive:</span>
              <span className="text-gray-100 font-bold text-lg">
                {Number(buyAmount || 0).toLocaleString()} IDA
              </span>
            </div>
            <div className="flex justify-between">
              <span className="text-gray-100 font-medium">Price per IDA:</span>
              <span className="text-white text-shadow-sm">
                {currentPrice.toFixed(6)} EGLD
              </span>
            </div>
            <div className="flex justify-between">
              <span className="text-gray-100 font-medium">Available:</span>
        ...
        <Button
          ...
          className={`w-full py-5 text-xl font-bold rounded-xl transition-all duration-300 flex items-center justify-center gap-3 ${
            isPhaseActive && !pending && isLoggedIn
              ? 'bg-gradient-to-r from-purple-500 to-indigo-500 hover:from-purple-600 hover:to-indigo-600 text-white shadow-xl hover:shadow-2xl hover:-translate-y-1 transform focus:ring-4 focus:ring-purple-400/50'
        ...
        >
          {!isLoggedIn
            ...
            ? 'Processing...'
            : 'BUY IDA TOKENS'}
          {!pending && isPhaseActive && isLoggedIn && <ArrowRight size={24} aria-hidden="true" />}
        </Button>
        ...
        <div className="space-y-8">
          ...
          <div className="text-center space-y-8">
            <div className="flex items-center justify-center gap-4">
              ...
              />
              <div>
                <h1 className="text-5xl md:text-6xl font-bold bg-gradient-to-r from-white via-purple-100 to-indigo-100 bg-clip-text text-transparent">
                  IDA Token Sale
                </h1>
                <p className="text-gray-100 text-xl font-medium mt-2">
            ...
            {/* Stats Overview */}
            <div className="bg-gray-900/90 rounded-3xl shadow-2xl border border-gray-700/50 p-8">
              <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                <div className="text-center">
                  ...
                  <p className="text-gray-100 text-sm font-medium uppercase tracking-wide">Total Raised</p>
                  <p className="text-3xl font-bold text-white mt-2 text-shadow-sm">
                ...
                <div className="text-center">
                  <div className="w-20 h-20 bg-gradient-to-r from-green-600 to-emerald-600 rounded-full flex items-center justify-center mx-auto mb-4 shadow-lg">
                    <Coins size={24} className="text-white" aria-hidden="true" />
                  </div>
                  <p className="text-gray-100 text-sm font-medium uppercase tracking-wide">Tokens Sold</p>
                  <p className="text-3xl font-bold text-white mt-2 text-shadow-sm">
                ...
                <div className="text-center">
                  ...
                  <p className="text-gray-100 text-sm font-medium uppercase tracking-wide">Current Phase</p>
                  <p className="text-3xl font-bold text-white mt-2 text-shadow-sm">
                    Phase {currentPhase}
                  </p>
                  <p className="text-gray-100 text-sm mt-1">
                ...
                <div className="text-center">
                  <div className="w-20 h-20 bg-gradient-to-r from-orange-600 to-red-600 rounded-full flex items-center justify-center mx-auto mb-4 shadow-lg">
                    <DollarSign size={24} className="text-white" aria-hidden="true" />
                  </div>
                  <p className="text-gray-100 text-sm font-medium uppercase tracking-wide">EGLD Price</p>
                  <p className="text-3xl font-bold text-white mt-2 text-shadow-sm">
          ...
          <div className="space-y-8">
            <div className="text-center">
              <h2 className="text-4xl font-bold text-white mb-6 text-shadow-sm">Token Sale Phases</h2>
              <p className="text-gray-100 text-xl max-w-4xl mx-auto leading-relaxed">
            ...
            {isLoading ? (
              <div className="flex justify-center py-16">
                <div className="space-y-4 text-center">
                  ...
                  <p className="text-white text-lg text-shadow-sm">Loading sale data from smart contract...</p>
                </div>
              </div>
            ) : (
          ...
          {/* Benefits Section */}
          <div className="bg-gray-900/90 rounded-3xl shadow-2xl border border-gray-700/50 p-10">
            <h3 className="text-3xl font-bold text-white mb-10 text-center text-shadow-sm">
              Why Choose IDA Tokens?
            </h3>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              <div className="text-center space-y-6 p-6 bg-gray-900/90 rounded-2xl border border-gray-700/50 hover:bg-gray-800/90 transition-all duration-300">
                <div className="w-20 h-20 bg-gradient-to-r from-purple-600 to-indigo-600 rounded-full flex items-center justify-center mx-auto shadow-lg">
                  <Zap size={24} className="text-white" aria-hidden="true" />
                </div>
                <h4 className="text-xl font-bold text-white text-shadow-sm">Zero Fees</h4>
              ...
              <div className="text-center space-y-6 p-6 bg-gray-900/90 rounded-2xl border border-gray-700/50 hover:bg-gray-800/90 transition-all duration-300">
                <div className="w-20 h-20 bg-gradient-to-r from-green-600 to-emerald-600 rounded-full flex items-center justify-center mx-auto shadow-lg">
                  <Award size={24} className="text-white" aria-hidden="true" />
                </div>
                <h4 className="text-xl font-bold text-white text-shadow-sm">Premium Access</h4>
                <p className="text-gray-100 text-base leading-relaxed">
              ...
              <div className="text-center space-y-6 p-6 bg-gray-900/90 rounded-2xl border border-gray-700/50 hover:bg-gray-800/90 transition-all duration-300">
                <div className="w-20 h-20 bg-gradient-to-r from-blue-600 to-cyan-600 rounded-full flex items-center justify-center mx-auto shadow-lg">
                  <Shield size={24} className="text-white" aria-hidden="true" />
                </div>
                <h4 className="text-xl font-bold text-white text-shadow-sm">Governance</h4>
                <p className="text-gray-100 text-base leading-relaxed">
              ...
              <div className="text-center space-y-6 p-6 bg-gray-900/90 rounded-2xl border border-gray-700/50 hover:bg-gray-800/90 transition-all duration-300">
                <div className="w-20 h-20 bg-gradient-to-r from-orange-600 to-red-600 rounded-full flex items-center justify-center mx-auto shadow-lg">
                  <DollarSign size={24} className="text-white" aria-hidden="true" />
                </div>
                <h4 className="text-xl font-bold text-white text-shadow-sm">Buyback & Burn</h4>
                <p className="text-gray-100 text-base leading-relaxed">
          ...
          <div className="bg-gray-900/90 rounded-3xl shadow-2xl border border-gray-700/50 p-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
              <div className="space-y-8">
                <div>
                  <h4 className="text-xl font-bold text-white mb-3 text-shadow-sm">
