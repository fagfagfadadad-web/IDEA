/*
  # Add order requirements and notifications

  1. Changes
    - Add requirements field to orders table
...
-- Add email field to users if it doesn't exist
DO $$
BEGIN
  IF NOT EXISTS (
...
-- Add requirements to orders if it doesn't exist
DO $$
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM information_schema.columns
